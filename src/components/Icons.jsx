...
export const ChevronUpSolid = ({ className }) => (
...
export const Cog8Tooth = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const LinkSolid = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const Cube16Solid = ({ className }) => (
...
export const ArrowTrendingUp = ({ className }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const LightningBolt = ({ className }) => (
